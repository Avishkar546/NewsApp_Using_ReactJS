...
export class News extends Component {
  ...
  componentDidMount = async() => { // In order to interact with the browser we use componentDidMount method. It is component lifecycle method.
    ...
    let response = await fetch(`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=fcc8f5c2ffe54e57b53b2b17cab248e0&page=${this.page}&pageSize=${this.props.pageSize}`);
